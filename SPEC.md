...
> **MVP scope (v1):** เฉพาะ ขนาดดอกเห็ด / จำนวนดอกเห็ด / พื้นที่ปกคลุม เท่านั้น รายการที่เหลือ (สี, รูปร่าง, ระยะการเจริญเติบโต, ความพร้อมเก็บเกี่ยว, ความผิดปกติ) **เลื่อนไป v2** เพราะต้องใช้ labeled dataset จำนวนมาก (classification 4 stage + disease ≥100 ภาพ/class × 4 class) เกินเวลาที่มีในรอบนี้ — ดู `.planning/REQUIREMENTS.md`

| รายการ | หน่วย/นิยาม | เกณฑ์ยอมรับ | Scope |
|---|---|---|---|
| ขนาดดอกเห็ด | เส้นผ่านศูนย์กลาง (cm) หลัง calibration pixel→cm | error ≤ 10% เทียบกับวัดจริงในชุด validation | **v1** |
| จำนวนดอกเห็ด | count ต่อภาพ (รวม partial-occluded ที่ระบุ ≥50% ของดอกมองเห็น) | count error ≤ 15% | **v1** |
| พื้นที่ปกคลุม | % ของพื้นที่ถาด/ชั้นที่ถูกปกคลุม | error ≤ 10% | **v1** |
| สีของเห็ด | ค่าเฉลี่ย RGB/HSV ของ region เห็ด เทียบกับ reference color chart | classification accuracy ≥ 85% (ปกติ/ผิดปกติ) | v2 (deferred) |
| รูปร่าง | shape descriptor (aspect ratio ของ cap) ใช้ประกอบ stage classification | ไม่ตั้ง metric เดี่ยว ใช้รวมกับ C2-stage | v2 (deferred) |
| ระยะการเจริญเติบโต | classification เป็น 4 stage: pin / young / mature / overmature (ต้อง label โดยผู้เชี่ยวชาญ) | accuracy ≥ 80% เทียบ label ผู้เชี่ยวชาญ | v2 (deferred) |
| ความพร้อมเก็บเกี่ยว | derived rule จาก stage=mature + size ≥ threshold ที่กำหนดโดยผู้เชี่ยวชาญ (ไม่ใช่ subjective AI judgment ตรง ๆ) | validate กับผู้เชี่ยวชาญ ≥ 90% agreement | v2 (deferred) |
| ความผิดปกติของเห็ด | classification เป็น class ที่กำหนดล่วงหน้า: เชื้อรา (mold), เน่า (rot), แคระ (stunted), สีผิดปกติ (discoloration) | precision ≥ 80% ต่อ class, ต้องมี labeled dataset ต่อ class ≥ 100 ภาพ | v2 (deferred) |
