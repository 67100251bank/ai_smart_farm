...
**Core Value:** Keep the greenhouse's temperature and humidity within safe growing ranges — automatically when possible, safely degraded when sensors/AI/actuators fail — so mushroom yield and quality are not lost to preventable environmental drift.
