...
- [ ] CV pipeline (YOLOv8 + classification models) measures mushroom size, count, coverage area, color, stage, and flags harvest-readiness and anomalies/disease — each with a defined unit and accuracy target against a labeled validation set
